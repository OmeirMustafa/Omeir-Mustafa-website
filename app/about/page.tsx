...
export default function AboutPage() {
    return (
        <main className="bg-background min-h-screen pt-24">
            <Section h1 heading="About Me" headingMuted="The Architect" description="Building production-grade AI systems and teaching others how to leverage automation for the future of work.">
                <Container>
                    <div className="grid md:grid-cols-12 gap-12 md:gap-16 items-start mb-24">
                        <div className="md:col-span-7 space-y-6 text-lg text-foreground-muted leading-relaxed">
                            <p>
                        ...
                        <div className="md:col-span-5">
                            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-zinc-900 border border-border">
                                <Image
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-8">
                                    ...
                                    <p className="text-sm font-mono text-foreground-muted uppercase tracking-widest mb-4">Product Architect</p>
