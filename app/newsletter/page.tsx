        ...
        <main className="bg-background min-h-screen pt-32 pb-24">
            <Container size="md">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <div className="w-14 h-14 mb-8 rounded-2xl bg-white/5 border border-border-hover flex items-center justify-center text-white">
                            <Sparkles size={24} strokeWidth={1.5} />
                        </div>
                        
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-[1.1]">
                            Stay Ahead <br />
                            <span className="text-muted-foreground">of the Curve</span>
                        </h1>
                        
                        <p className="text-lg text-foreground-muted leading-relaxed mb-10 max-w-md">
                        ...
                        <div className="bg-muted/50 p-6 md:p-8 rounded-3xl border border-border-hover mb-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {benefits.map((benefit, idx) => (
                            <div key={idx} className="flex gap-5 p-6 rounded-3xl bg-white/[0.02] border border-border">
                                <div className="w-12 h-12 rounded-xl bg-white/5 border border-border-hover flex items-center justify-center text-white flex-shrink-0">
